...
<!--Header med text-->
<div style="background: linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) ), url(./img/gavle.jpg); background-position-y: 60%; background-size: cover;" repeat; class="jumbotron text-center">
  <h1 id="stad-text" style="font-family:myFirstFont; text-shadow: 1px 1px 1px black;">REAL - TEKNIK</h1>
  <h2 style="font-family: myFirstFont; font-size:24px; color: #ffffff; text-shadow: 1px 1px 1px black;">GÄVLE</h2>
</div>
