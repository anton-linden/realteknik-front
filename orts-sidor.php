...
<div style="background: linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) ), url(./img/norrkoping.jpg); background-position-y: 60%; background-size: cover;" repeat; class="jumbotron text-center">
  <p id="stad-text" style="font-family:myFirstFont; font-size: 64px; text-shadow: 1px 1px 1px black;">REAL - TEKNIK</p>
  <p style="font-family: myFirstFont; font-size:24px; text-shadow: 1px 1px 1px black;">NORRKÖPING</p>
</div>
