...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="amnen">
        ...
        <h2>Ämne</h2>
        <p>Bild Namn</p>
        <input id="bildNamn" type="text" name="bNamn"/>
        <p> Bild </p>
        <input id="file" type="file" name="upload" id="bild" />
        <p> Titel </p>
        <input type="text" name="rubrik" id="title">
        <p>Text</p>
        <p><textarea placeholder="Skriv här..." cols="20" rows="3" name="text" id="description"></textarea></p>
        <br>
        <br>
        <!-- Submit button -->
